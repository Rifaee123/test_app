...
class StudentDashboardViewModel extends Equatable {
  ...
  factory StudentDashboardViewModel.fromEntity(Student student) {
    return StudentDashboardViewModel(
      ...
      parentName: student.parentName ?? "Not Set",
      semester: student.semester ?? "Current",
      attendancePercentage:
          '${((student.attendance ?? 0) * 100).toStringAsFixed(0)}%',
      attendanceProgress: student.attendance ?? 0,
      avgMarksPercentage:
          '${((student.averageMarks ?? 0) * 100).toStringAsFixed(1)}%',
      avgMarksProgress: student.averageMarks ?? 0,
